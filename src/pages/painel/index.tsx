import { PainelContainer, PainelTitle, ListaEntradasSaidas, ItemEntradaSaida, Coluna } from "./style";

interface RegistroMovimentacao {
  id: number;
  data: string; // data completa
  horario: string;
  tipo: "Entrada" | "Saída";
...
export function PainelEntradasSaidas() {
  ...
  const registros: RegistroMovimentacao[] = [
    { id: 1, data: "2025-05-30", horario: "07:15", tipo: "Entrada", codigoVeiculo: "ABC-1234", motorista: "João Silva" },
    { id: 2, data: "2025-05-30", horario: "12:30", tipo: "Saída", codigoVeiculo: "ABC-1234", motorista: "João Silva" },
      ...
      <ListaEntradasSaidas>
        ...
        {registros.map((registro) => (
          <ItemEntradaSaida key={registro.id}>
            ...
            <Coluna flex="2">
              <span className={registro.tipo === "Entrada" ? "status-entrada" : "status-saida"}>
                {registro.tipo}
              </span>
            </Coluna>
